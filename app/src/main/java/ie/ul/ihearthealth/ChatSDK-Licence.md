IHeartHealth's chat module uses the Android Chat SDK library, available on Github: https://github.com/chat-sdk/chat-sdk-android and licenced as below.

Copyright 2020 Smiley Brothers LTD
